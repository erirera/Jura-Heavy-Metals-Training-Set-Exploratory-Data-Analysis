...
<title>Jura EDA Dashboard &mdash; Prediction Set (n=259)</title>
...
<header>
  ...
  <div class="nav-group" style="display:flex;gap:12px;margin-left:auto;align-items:center">
    ...
    <a href="../prediction set map/index.html" class="nav-btn">Spatial Maps &rarr;</a>
    <a href="../../Validation set/validation set EDA/index.html" class="nav-btn">Validation Set &rarr;</a>
  </div>
</header>
<main>
...
<div class="grid-2" style="margin-top:24px">
  <div class="card">
    <div class="card-title">Mean by Rock Type <span style="font-weight:400;color:#555588;font-size:.75rem;">(youngest &rarr; oldest)</span></div>
...
// Doughnuts — rock ordered youngest→oldest via ROCK_C key insertion order
...
print(f"Prediction EDA Dashboard written -> {out}")
print(f"Rows: {n}")